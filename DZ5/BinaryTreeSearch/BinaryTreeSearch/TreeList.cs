...
namespace BinaryTreeSearch
{
    ...
    public class TreeList : ITree
    {
        ...
        // Поиск в ширину (для каждого элемента, который мы достаем из очереди мы заносим в нее его дочерние элементы (если они существуют)
        public void BFS(int value )
        {
            ...
            Console.WriteLine("NODE NOT FOUND 404");
        }
